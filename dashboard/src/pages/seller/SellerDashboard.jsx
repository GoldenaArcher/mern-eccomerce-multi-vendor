...
const cardData = createCardData([
  { title: "$3434", subtitle: "Total Sale", icon: "currency", color: "red" },
  { title: "50", subtitle: "Products", icon: "products", color: "purple" },
  { title: "10", subtitle: "Orders", icon: "cart", color: "green" },
  { title: "1", subtitle: "Pending Orders", icon: "cart", color: "blue" },
]);

// prettier-ignore
const sellerDashboardColumnHeader = [
  ...
  return (
    <div className="px-2 md:px-7 py-5">
      ...
      <div className="w-full p-4 bg-[#6a5fdf] rounded-md mt-6">
        ...
        <Table
          columns={sellerDashboardColumnHeader}
          data={dummyData}
